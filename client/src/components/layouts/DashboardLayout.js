...
const DashboardLayout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Çoklu Bilanço Analizi', href: '/multi-balance-analysis', icon: DocumentChartBarIcon },
    { name: 'Oransal Analiz', href: '/ratio-analysis', icon: CalculatorIcon },
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <img className="h-8 w-auto" src="/logo.svg" alt="Mali Analiz" />
            </div>
